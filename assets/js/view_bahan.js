$(document).ready(function(){
      ...
      /*start to calculate total pembelian bahan*/
        $("#stok,#harga").keyup(function () {
        $('#total_pembelian').val($('#stok').val() * $('#harga').val());
        });
      /*end to calculate total pembelian bahan*/
	...
	$("#cetak").click(function(){
        ...
        $("#report_dayly").click(function(){
                window.open(url+'bahan/cetakDayly',);
        })
