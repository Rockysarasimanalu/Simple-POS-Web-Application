...
MySQL - 10.1.21-MariaDB : Database - simpangsadang
*********************************************************************
*/
...
CREATE DATABASE /*!32312 IF NOT EXISTS*/`simpangsadang` /*!40100 DEFAULT CHARACTER SET latin1 */;
...
CREATE TABLE `bahan` (
  ...
  `total_pembelian` varchar(15) DEFAULT NULL,
  PRIMARY KEY (`no_bahan`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

/*Data for the table `bahan` */

insert  into `bahan`(`no_bahan`,`nama`,`harga`,`stok`,`satuan`,`supplier`,`tanggal`,`total_pembelian`) values 
('B001','Avena Minyak Goreng 5 ltr',100,10,'PCS','Toko Haji Muhidin','2017-07-06','14000'),
('B002','Beras Ketan Hitam Curah /',7000,2,'TON','Toko Haji Muhidin','2017-07-03','14000'),
('B003','Beras Ketan Putih Curah /',9000,1,'CG','Toko Haji Muhidin',NULL,NULL),
('B004','Bimoli Minyak Goreng Boto',15000,1,'TON','Toko Haji Muhidin',NULL,NULL),
('B005','Bimoli Minyak Goreng Klas',25000,1,'PCS','Toko Haji Muhidin',NULL,NULL),
('B006','Bimoli N.Kolesterol Jerig',23000,1,'DAG','Toko Haji Muhidin',NULL,NULL),
('B007','Bimoli Special Refil 2ltr',26000,1,'DG','Toko Haji Muhidin',NULL,NULL),
('B008','Bimoli Special Refill 1lt',15000,9,'CG','Toko Haji Muhidin',NULL,NULL),
('B009','Filma Minyak Goreng Non K',13000,1,'ONS','Toko Haji Muhidin',NULL,NULL),
('B010','Filma Refil 2 ltr (minyak goreng)',26000,1,'DAG','Toko Haji Muhidin',NULL,NULL),
('B011','Gula Merah Curah 1/2 Kg',4000,1,'KG','Toko Haji Muhidin',NULL,NULL),
('B012','Gula Merah Curah 1/4 Kg',3000,1,'KG','Toko Haji Muhidin',NULL,NULL),
('B013','Hemart & Higienis 1000ml',11000,1,'KUINTAL','Toko Haji Muhidin',NULL,NULL),
('B014','Hemart minyak goreng 2000',21000,1,'BOTOL','Toko Haji Muhidin',NULL,NULL),
('B015','Honig Macaroni 100gr',7000,1,'DAG','Toko Haji Muhidin',NULL,NULL),
('B016','Honig Macaroni 200gr',7000,1,'ONS','Toko Haji Muhidin',NULL,NULL),
('B017','Kunci Mas 1ltr',12000,1,'KG','Toko Haji Muhidin',NULL,NULL),
('B018','Kunci Mas Refill 2ltr ? p',24000,6,'KUINTAL','Toko Haji Muhidin',NULL,NULL),
('B019','Madina Minyak Goreng 1ltr',12000,1,'KG','Toko Haji Muhidin',NULL,NULL),
('B021','Madina Minyak Goreng 5ltr',55000,1,'KG','Toko Haji Muhidin',NULL,NULL),
('B022','Palma Minyak Goreng 2ltr ',22000,1,'GRAM','Toko Haji Muhidin',NULL,NULL),
('B023','Rose Brand Tepung Beras 5',4000,1,'KG','Toko Haji Muhidin',NULL,NULL),
('B024','Rose Brand Tepung Ketan P',5000,1,'TON','Toko Haji Muhidin',NULL,NULL),
('B025','Sania Minyak Goreng 2l tr',25000,1,'DAG','Toko Haji Muhidin',NULL,NULL),
('B026','Sania Minyak Goreng Non K',25000,1,'PCS','Toko Haji Muhidin',NULL,NULL),
('B027','Andaliman',8000,3,'GRAM','Toko Haji Muhidin','2017-06-08','24000');
...
/*Data for the table `level_pedas` */
...
('MRO00004','Saksang','ROASTED',10000,'y'),
...
insert  into `pembelian`(`no_pembelian`,`no_faktur`,`tanggal`,`waktu`,`supplier`,`item`,`harga`,`jumlah`,`total`) values 
('1','1','2017-06-22','00:00:20','KALLA','1',40000,4,0);
...
('JL17000007',1,'2017-06-19','18:17:50',32000,0,0,32000,100000,68000,'casheir'),
('JL17000008',1,'2017-07-02','17:35:12',6000,0,0,6000,10000,4000,'casheir'),
('JL17000009',1,'2017-07-03','17:26:03',32000,0,0,32000,100000,68000,'casheir');
...
('JL17000007','2017-06-19','Chicken Crispy Spicy','SPICY AND CRYSPY',16000,2,32000),
('JL17000008','2017-07-02','Tuak','DRINKS',3000,2,6000),
('JL17000009','2017-07-03','Chicken Crispy Spicy','SPICY AND CRYSPY',16000,2,32000);
...
(1,'08282828','Rumah Makan Simpang Sadan','JLn Subang KM 1 Sadang Terminal Square','08122204761','2B50BB10','simpangsadang@gmail.com','Simpang Sadang','@Simpangsadang','admin','2014-05-01','12:00:00','12:00:00');
